...
test("path overview page renders 11 chapter cards in order: Lessons 1-5 active, Lessons 6-11 in preparation", async ({ page }) => {
  ...
  await expect(activeCards).toHaveCount(5);
