...
const abuBakrPresentation: Record<AbuBakrCanonicalSlug, Omit<BiographyChapter, "canonicalSlug" | "slug" | "number">> = {
  ...
  "abu_bakr.lesson_04_companion_of_the_cave": { title: { ar: "رفيق الغار", en: "Companion of the Cave" }, description: { ar: "الهجرة النبوية ورحلة الغار.", en: "The Hijrah and the journey to the cave." }, state: "active", contentReady: true },
  "abu_bakr.lesson_05_abu_bakr_in_madinah": { title: { ar: "أبو بكر في المدينة", en: "Abu Bakr in Madinah" }, description: { ar: "بدر، وتبوك، وآخر حجٍّ قاده النبي ﷺ.", en: "Badr, Tabuk, and the last Hajj the Prophet ﷺ led." }, state: "active", contentReady: true },
  "abu_bakr.lesson_06_final_illness_and_death": { title: { ar: "المرض الأخير ووفاة النبي ﷺ", en: "The Final Illness and Death of the Prophet ﷺ" }, description: { ar: "كيف تصرَّف أبو بكر في مرض النبي ﷺ الأخير ووفاته.", en: "How Abu Bakr responded during the Prophet's ﷺ final illness and death." }, state: "active", contentReady: true },
