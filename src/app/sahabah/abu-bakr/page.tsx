    ...
    <main>
      <section className="surah-hero bio-companion-hero">
        <div className="shell surah-hero-grid">
          <div>
            ...
            <p>{language === "ar" ? "١١ فصلًا · الفصول الخمسة الأولى محتوى حقيقي، والبقية بنية مبدئية قيد الإعداد" : "11 chapters · Chapters 1–5 have real content, the rest are draft structure in progress"}</p>
      ...
      <div className="shell path-layout">
        ...
        <aside className="path-context">
          ...
          <p>{language === "ar" ? "الفصول الخمسة الأولى محتوى حقيقي موثّق بالأدلة، ولا تزال داخلية وبانتظار المراجعة العلمية النهائية قبل أي نشر. بقية الفصول (٦–١١) لا تزال بنية مسار بمحتوى عنصر نائب بانتظار إعدادها." : "Chapters 1–5 have real, evidence-traced content — still internal and pending final scholarly review before any publication. Chapters 6–11 remain a path structure with placeholder content, pending preparation."}</p>
        </aside>
      </div>
    </main>
  );
